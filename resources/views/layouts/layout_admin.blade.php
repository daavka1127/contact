            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{{url("/home")}}"><i class="fa fa-file-text-o"></i> Утасны жагсаалт </a></li>
                  <li><a><i class="fa fa-user"></i>Туслах сан<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('/')}}">Харъяалал</a></li>
                      <li><a href="{{url('/')}}">Албад хэлтэс</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
